...
! function(t) {
    ...
    r.resize = A(c, O), r.scroll = A(c, "scroll.webflow resize.webflow orientationchange.webflow load.webflow"), r.redraw = A(), r.location = function(t) {
        ...
        t = t || {}, v = !0, c.triggerHandler("__wf_destroy"), null != t.domready && (p = t.domready), l.each(i, h), r.resize.off(), r.scroll.off(), r.redraw.off(), o = [], a = [], "pending" === T.state() && w()
    ...
    e.clone = c, e.addLast = l, e.addFirst = d, e.removeLast = p, e.removeFirst = v, e.insert = E, e.removeAt = h, e.replaceAt = _, e.getIn = g, e.set = I, e.setIn = m, e.update = y, e.updateIn = T, e.merge = O, e.mergeDeep = A, e.mergeIn = S, e.omit = w, e.addDefaults = b;
    /*!
     * Timm
     *
                ...
                i ? function(t) {
                    ...
                    if ((0, f.default)(d)) {
                        (0, v.default)(d, function(t, e) {
                            ...
                            if ($(p, u.mediaQueryKeys) || n.dispatch((0, I.mediaQueriesDefined)()), a.actionTypeId === P) {
    ...
    n(102), n(103), n(105), n(27), n(107), n(260), n(261), n(262), n(263), n(268), n(269), t.exports = n(270)
}, function(t, e, n) {
    "use strict";
    var r = n(0)(n(11));
    ! function() {
    ...
    t.exports = function(t, e, n, a, u, c) {
        ...
        if (E && !h) {
            var m = t.constructor,
                y = e.constructor;
            m != y && "constructor" in t && "constructor" in e && !("function" == typeof m && m instanceof m && "function" == typeof y && y instanceof y) && (E = !1)
        }
        ...
        switch (i) {
            ...
            case m.STYLE_TEXT_COLOR:
                var A = n.config,
                    ...
                    R = A.aValue;
                return {
                    rValue: S, gValue: w, bValue: b, aValue: R
                };
            case m.STYLE_FILTER:
    ...
    var r = n(3),
        ...
        y = function(t, e) {
            ...
            if (h && !_)
                for (var P = 0, D = a.length; P < D; P++) {
                    ...
                    for (var F = (O - I) / m, j = h.config.easing, G = v(j, F, f), V = 0, U = a.length; V < U; V++) {
                        var X = a[V],
                            k = g(s, X, h.config),
        ...
        T = function(t, e) {
            var n = t,
                ...
                y = m.duration,
                T = m.delay;
            null != E && (y = E), T = null != _ ? _ : T, c === h ? y = 0 : u && (y = T = 0);
            var O = e.payload.now;
            if (r && o) {
                var A = O - (a + T);
                if (s) {
    ...
    var c, s, f, l = u(n(26)),
        ...
        It = (r = {}, (0, o.default)(r, b, ht()), (0, o.default)(r, R, _t()), (0, o.default)(r, w, ht()), (0, o.default)(r, S, _t()), (0, o.default)(r, x, ht(!1)), (0, o.default)(r, L, _t(!1)), (0, o.default)(r, N, ht()), (0, o.default)(r, C, _t()), (0, o.default)(r, W, {
            ...
            handler: function(t) {
                ...
                return O && (A > .95 || A < .05) && (A = Math.round(A)), (u !== Y || w || w !== a.elementHovered) && (A = f ? 1 - A : A, e.dispatch((0, h.parameterChanged)(S, A))), {
                    elementHovered: w,
                    clientX: v,
                    clientY: _,
                    pageX: I,
                ...
                ! function(e, n) {
                    ...
                    if (_) f.on("click", function(t) {
                        ...
                        E.on("click", function() {
                            ...
                            (r = i.target && i.target.files && i.target.files[0]) && (o.toggle(!1), s.toggle(!1), a.toggle(!0), h.text(r.name), b() || T(n), n.fileUploads[e].uploading = !0, function(e, n) {
                                var r = {
                                    name: e.name,
                                    size: e.size
                                };
    ...
    r.define("navbar", t.exports = function(t, e) {
        ...
        function P(t, e) {
            if (!t.open) {
                t.open = !0, t.menu.addClass(h), t.links.addClass(m), t.dropdowns.addClass(_), t.dropdownToggle.addClass(g), t.dropdownList.addClass(I), t.button.addClass(E);
                var n = t.config;
                ...
                var i = D(t),
                    ...
                    c = t.el.height(),
                    f = t.el[0];
                if (L(0, f), y.intro(0, f), r.redraw.up(), a || l.on("tap" + v, t.outside), !e) {
        ...
        function M(t, e) {
            ...
            function c() {
                t.menu.height(""), s(t.menu).set({
                    x: 0,
                    y: 0
                }), t.menu.removeClass(h), t.links.removeClass(m), t.dropdowns.removeClass(_), t.dropdownToggle.removeClass(g), t.dropdownList.removeClass(I), t.overlay && t.overlay.children().length && (T.length ? t.menu.insertAfter(T) : t.menu.prependTo(t.parent), t.overlay.attr("style", "").hide()), t.el.triggerHandler("w-close")
            }
        }
        return c
    })
    ...
    r.define("slider", t.exports = function(t, e) {
        ...
        function g(e, n) {
            ...
            f.show(), w(e, n), c.css("display", ""), f.css("display", "")
        }
        ...
        function S(e, n) {
            ...
            var l = e.offsetX || 0,
                ...
                T = "opacity " + m + "ms " + I,
                O = "transform " + m + "ms " + I;
            if (o || (E.each(v.intro), _.each(v.outro)), n.immediate && !u) return s(E).set(p), void w();
            if (e.index !== e.previous) {
                if ("cross" === g) {
                    var A = Math.round(m - m * r.crossOver),
                        S = Math.round(m - A);
                    return T = "opacity " + A + "ms " + I, s(h).set({
                        visibility: ""
                    }).add(T).start({
                        opacity: 0
                    }), void s(E).set({
    ...
    r.define("maps", t.exports = function(t, e) {
        var n, i = {},
            ...
            a = null,
            u = ".w-widget-map",
            c = "AIzaSyBOJHK2QhK-I6b15uEFTc-5p-f9cLRawG8";
    ...
    "events": {
        "e-99": {
            ...
            "target": {
                "appliesTo": "ELEMENT",
                "styleBlockIds": [],
                "id": "5e12be890227d04c89807d55|4c620c6d-ebc5-7431-1daa-fec9e5d3361c"
            },
            "config": {
                "loop": false,
                "playInReverse": false,
        ...
        "e-101": {
            ...
            "target": {
                "appliesTo": "ELEMENT",
                "styleBlockIds": [],
                "id": "5e12be890227d04c89807d55|f3c89edb-6c31-0b95-10ef-5f40ddd96a1d"
            },
            "config": {
                "loop": false,
                "playInReverse": false,
        ...
        "e-103": {
            ...
            "target": {
                "appliesTo": "ELEMENT",
                "styleBlockIds": [],
                "id": "5e12be890227d04c89807d55|15007825-5bf4-4329-703a-a182a815547a"
            },
            "config": {
                "loop": false,
                "playInReverse": false,
        ...
        "e-105": {
            ...
            "target": {
                "appliesTo": "ELEMENT",
                "styleBlockIds": [],
                "id": "5e12be890227d04c89807d55|66323c39-a11e-84f1-69ad-181e444e10b9"
            },
            "config": {
                "loop": false,
                "playInReverse": false,
        ...
        "e-107": {
            ...
            "target": {
                "appliesTo": "ELEMENT",
                "styleBlockIds": [],
                "id": "5e12be890227d04c89807d55|274a95b1-5b47-c4c0-7224-6b71c034ead2"
            },
            "config": {
                "loop": false,
                "playInReverse": false,
        ...
        "e-109": {
            ...
            "target": {
                "appliesTo": "ELEMENT",
                "styleBlockIds": [],
                "id": "5e12be890227d04c89807d55|87b55c25-315b-949b-fc03-f00c8b552b0d"
            },
            "config": {
                "loop": false,
                "playInReverse": false,
        ...
        "e-111": {
            ...
            "target": {
                "appliesTo": "ELEMENT",
                "styleBlockIds": [],
                "id": "5e12be890227d04c89807d55|d94b27fd-7fd8-e4f1-369b-f56da267e223"
            },
            "config": {
                "loop": false,
                "playInReverse": false,
        ...
        "e-117": {
            ...
            "target": {
                "appliesTo": "ELEMENT",
                "styleBlockIds": [],
                "id": "5e12be890227d04c89807d55|4cc01e60-e3c1-983b-3ee2-e5cfe117388c"
            },
            "config": {
                "loop": false,
                "playInReverse": false,
        ...
        "e-119": {
            ...
            "target": {
                "appliesTo": "ELEMENT",
                "styleBlockIds": [],
                "id": "5e12be890227d04c89807d55|4cc01e60-e3c1-983b-3ee2-e5cfe117388d"
            },
            "config": {
                "loop": false,
                "playInReverse": false,
        ...
        "e-121": {
            ...
            "target": {
                "appliesTo": "ELEMENT",
                "styleBlockIds": [],
                "id": "5e12be890227d04c89807d55|544b743e-2617-d60d-84a0-32265f41523b"
            },
            "config": [{
        ...
        "e-122": {
            ...
            "target": {
                "appliesTo": "ELEMENT",
                "styleBlockIds": [],
                "id": "5cdafcb9a2808913d5d78d5e|6b1645b1-3974-05d5-6966-4ec0c5a1c33e"
            },
            "config": [{
                "continuousParameterGroupId": "a-32-p",
                "smoothing": 50,
        ...
        "e-123": {
            ...
            "target": {
                "appliesTo": "ELEMENT",
                "styleBlockIds": [],
                "id": "5e12be890227d04c89807d55|2e632d60-a0d7-2718-3898-b5962cbd2b5f"
            },
            "config": {
                "loop": false,
                "playInReverse": false,
        ...
        "e-125": {
            ...
            "target": {
                "appliesTo": "ELEMENT",
                "styleBlockIds": [],
                "id": "5e12be890227d04c89807d55|d94ac908-2986-bb2d-255a-4d3d2a7e10b4"
            },
            "config": {
                "loop": false,
                "playInReverse": false,
        ...
        "e-127": {
            ...
            "target": {
                "appliesTo": "ELEMENT",
                "styleBlockIds": [],
                "id": "5e12be890227d04c89807d55|71787401-5838-1342-bfdf-1410372b8e1b"
            },
            "config": {
                "loop": false,
                "playInReverse": false,
        ...
        "e-129": {
            ...
            "target": {
                "appliesTo": "ELEMENT",
                "styleBlockIds": [],
                "id": "5e12be890227d04c89807d55|4aba87a5-0160-40a2-34a3-a39fa3353505"
            },
            "config": {
                "loop": false,
                "playInReverse": false,
        ...
        "e-131": {
            ...
            "target": {
                "appliesTo": "ELEMENT",
                "styleBlockIds": [],
                "id": "5e12be890227d04c89807d55|f4ba7a30-7392-3839-d087-f0deade65866"
            },
            "config": {
                "loop": false,
                "playInReverse": false,
        ...
        "e-133": {
            ...
            "target": {
                "appliesTo": "ELEMENT",
                "styleBlockIds": [],
                "id": "5e12be890227d04c89807d55|d420b798-4846-6adf-4291-57327dcd67d4"
            },
            "config": {
                "loop": false,
                "playInReverse": false,
        ...
        "e-135": {
            ...
            "target": {
                "appliesTo": "ELEMENT",
                "styleBlockIds": [],
                "id": "5e12be890227d04c89807d55|767cff74-07a0-2d5f-385c-61ca572b9bdb"
            },
            "config": {
                "loop": false,
                "playInReverse": false,
            ...
            "createdOn": 1578396177935
        }
    },
    "actionLists": {
        "a-18": {
            "id": "a-18",
            "title": "Show Practice Full List 2",
            "actionItemGroups": [{
                "actionItems": [{
                    "id": "a-18-n",
                    ...
                    "config": {
                        ...
                        "value": "none",
                        "target": {
                            "id": "5e12be890227d04c89807d55|63467b7b-7b28-de67-3772-0ceff9964d91"
                        }
                    }
                }, {
                    "id": "a-18-n-2",
            ...
            "createdOn": 1543007814362,
            "useFirstGroupAsInitialState": true
        },
        "a-19": {
            "id": "a-19",
            "title": "Hide Practice Full List 2",
            "actionItemGroups": [{
                "actionItems": [{
                    "id": "a-19-n",
                    "actionTypeId": "TRANSFORM_MOVE",
            ...
            "createdOn": 1543143565780,
            "useFirstGroupAsInitialState": false
        },
        "a-20": {
            "id": "a-20",
            "title": "Facts 3 Full Display 2",
            "actionItemGroups": [{
                "actionItems": [{
                    "id": "a-20-n",
                    "actionTypeId": "TRANSFORM_MOVE",
                    "config": {
                        ...
                        "duration": 500,
                        "target": {
                            "id": "5e12be890227d04c89807d55|66323c39-a11e-84f1-69ad-181e444e10ba"
                        },
                        "yValue": -15,
                        "xUnit": "PX",
                        "yUnit": "PX",
                    ...
                    "config": {
                        ...
                        "duration": 500,
                        "target": {
                            "id": "5e12be890227d04c89807d55|66323c39-a11e-84f1-69ad-181e444e10bc"
                        },
                        "yValue": 15,
                        "xUnit": "PX",
                        "yUnit": "PX",
            ...
            "createdOn": 1544040039979,
            "useFirstGroupAsInitialState": false
        },
        "a-21": {
            "id": "a-21",
            "title": "Facts 3 Partial Display 2",
            "actionItemGroups": [{
                "actionItems": [{
                    "id": "a-21-n",
                    "actionTypeId": "TRANSFORM_MOVE",
            ...
            "createdOn": 1544040644077,
            "useFirstGroupAsInitialState": false
        },
        "a-22": {
            "id": "a-22",
            "title": "Facts 1 Full Display 2",
            "actionItemGroups": [{
                "actionItems": [{
                    "id": "a-22-n",
                    "actionTypeId": "TRANSFORM_MOVE",
                    "config": {
                        ...
                        "duration": 500,
                        "target": {
                            "id": "5e12be890227d04c89807d55|274a95b1-5b47-c4c0-7224-6b71c034ead3"
                        },
                        "yValue": -15,
                        "xUnit": "PX",
                        "yUnit": "PX",
                    ...
                    "config": {
                        ...
                        "duration": 500,
                        "target": {
                            "id": "5e12be890227d04c89807d55|274a95b1-5b47-c4c0-7224-6b71c034ead5"
                        },
                        "yValue": 15,
                        "xUnit": "PX",
                        "yUnit": "PX",
            ...
            "createdOn": 1544041435298,
            "useFirstGroupAsInitialState": false
        },
        "a-23": {
            "id": "a-23",
            "title": "Facts 1 Partial Display 2",
            "actionItemGroups": [{
                "actionItems": [{
                    "id": "a-23-n",
                    "actionTypeId": "TRANSFORM_MOVE",
            ...
            "createdOn": 1544041554056,
            "useFirstGroupAsInitialState": false
        },
        "a-24": {
            "id": "a-24",
            "title": "Facts 2 Full Display 2",
            "actionItemGroups": [{
                "actionItems": [{
                    "id": "a-24-n",
                    "actionTypeId": "TRANSFORM_MOVE",
                    "config": {
                        ...
                        "duration": 500,
                        "target": {
                            "id": "5e12be890227d04c89807d55|87b55c25-315b-949b-fc03-f00c8b552b0e"
                        },
                        "yValue": -15,
                        "xUnit": "PX",
                        "yUnit": "PX",
                    ...
                    "config": {
                        ...
                        "duration": 500,
                        "target": {
                            "id": "5e12be890227d04c89807d55|87b55c25-315b-949b-fc03-f00c8b552b10"
                        },
                        "yValue": 15,
                        "xUnit": "PX",
                        "yUnit": "PX",
            ...
            "createdOn": 1544041646499,
            "useFirstGroupAsInitialState": false
        },
        "a-25": {
            "id": "a-25",
            "title": "Facts 2 Partial Display 2",
            "actionItemGroups": [{
                "actionItems": [{
                    "id": "a-25-n",
                    "actionTypeId": "TRANSFORM_MOVE",
            ...
            "createdOn": 1544041758562,
            "useFirstGroupAsInitialState": false
        },
        "a-26": {
            "id": "a-26",
            "title": "Facts 4 Full Display 2",
            "actionItemGroups": [{
                "actionItems": [{
                    "id": "a-26-n",
                    "actionTypeId": "TRANSFORM_MOVE",
                    "config": {
                        ...
                        "duration": 500,
                        "target": {
                            "id": "5e12be890227d04c89807d55|ccf51df3-2c3e-8302-7590-14992b1b69bf"
                        },
                        "yValue": -15,
                        "xUnit": "PX",
                        "yUnit": "PX",
                    ...
                    "config": {
                        ...
                        "duration": 500,
                        "target": {
                            "id": "5e12be890227d04c89807d55|9ebb017f-38c7-d0f8-892e-d9b1cd1d6c17"
                        },
                        "yValue": 15,
                        "xUnit": "PX",
                        "yUnit": "PX",
            ...
            "createdOn": 1544041841140,
            "useFirstGroupAsInitialState": false
        },
        "a-27": {
            "id": "a-27",
            "title": "Facts 4 Partial Display 2",
            "actionItemGroups": [{
                "actionItems": [{
                    "id": "a-27-n",
                    "actionTypeId": "TRANSFORM_MOVE",
                    ...
                    "actionItems": [{
                        ...
                        "config": {
                            ...
                            "target": {
                                ...
                                "selector": ".navbar",
                                "selectorGuids": ["819b55b8-13de-12d9-6377-d4c966304bb8"]
                            },
                            "rValue": 0,
                            "gValue": 0,
                            "bValue": 0,
