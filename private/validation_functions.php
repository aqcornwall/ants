<?php
  ...
  function img_format(){
    ...
    return $image_endsuffix_actual;
  }
  
  function img_format_is_right(){
    // $image = $_FILES['image'];
    // $image_name =  $image['name'];
    // $image_endsuffix = explode( '.', $image_name );
    $image_endsuffix_actual = img_format();
    $allowed = ['jpg', 'jpeg', 'png', 'svg' ];

    if ( in_array( $image_endsuffix_actual, $allowed ) ) {
      return true;
    }
  }
...
//*********************************************************blogs*************************************************************************
 ...
 function has_unique_blog_menu_name($menu_name, $current_id="0") {
    global $db;
